...
-- DropForeignKey
ALTER TABLE "Live" DROP CONSTRAINT "Live_authorId_fkey";
...
-- AddForeignKey
ALTER TABLE "Live" ADD CONSTRAINT "Live_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
