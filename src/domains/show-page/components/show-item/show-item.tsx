  ...
  return (
    <div className="flex items-center justify-between  text-neutral-900 border-b-2 last:border-b-0 border-gray-300 w-full py-3 gap-4">
      <div className="flex flex-col items-center justify-start min-w-[60px]">
        <Text type="p" className="text-sm text-left w-full">
          {moment(date).format("DD")}
        </Text>
        <Text type="p" className="text-md font-bold text-left w-full">
      ...
      <div className="flex-1">
        {title && (
          <div className="mb-1">
            <Text type="div" className="text-sm font-semibold">
              {title}
            </Text>
            <Text type="div" className="text-sm text-gray-600">
              @{location}
            </Text>
          </div>
        )}
