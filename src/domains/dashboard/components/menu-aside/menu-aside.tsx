...
const MenuAside = () => {
  ...
  return (
    <div className='w-2/12 flex flex-col gap-4 font-light text-white rounded-md p-3 bg-neutral-800'>
      <Link href='/dashboard/events' className={`flex items-center gap-2 border-b border-gray-200 border-opacity-20 border-1 text-sm rounded-sm p-1 ${isEvents ? 'bg-neutral-500' : ''}`}>
