export const GrainyEffect = function GrainyEffect(
...
export const DiscogsIcon = function DiscogsIcon(
  props: React.SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export const EarthIcon = function EarthIcon(
  props: React.SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export const Play = function Play(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export const Pause = function Pause(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export const Spotify = function Spotify(props: Spotify) {
...
export const Prev = function Prev(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
...
export const Next = function Next(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      className="h-8 w-8 text-neutral-500"
