...
const Header = ({ locale }: { locale: string }) => {
  ...
  return (
    <>
      <header ref={ref} className={`font-bold hidden md:flex group fixed w-full top-0  h-15  pt-2 pb-2 items-center gap-4 z-20 justify-between lg:justify-end transition-all duration-300 bg-neutral-900 ${isScrolledAfterHeader ? 'shadow-md shadow-neutral-800/50' : 'shadow-none'}`}>
        <Container >
